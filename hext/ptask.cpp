...
int ptask_php_post_deactivate(void)
{
      return SUCCESS;
}
 ...
 */
static zend_function_entry ptask_functions[] = {
    /* Base functions */
    ...
    {NULL, NULL, NULL, 0, 0}    /* Must be the last line in ptask_functions[] */
};
/* }}} */
...
PHP_GINIT_FUNCTION(ptask)
{
}
*/

/* zm_globals_dtor_dso_test 
PHP_GSHUTDOWN_FUNCTION(ptask)
{
}
*/
...
{
    //ZEND_INIT_MODULE_GLOBALS(ptask, php_ptask_init_globals, NULL);
...
PHP_FUNCTION(ptask_create)
{
    ...
    /* create task context */
    ctx = (struct ptask_ctx *)emalloc(sizeof(struct ptask_ctx));

    /* copy function name */
    ctx->func = (char *)emalloc(flen + 1);
